...
class ProfileCog(Cog):
    ...
    def remove_item_from_inventory(self, user_id: int, item_name: str, tokens_to_add: int):
        user_data = self.get_user_data(user_id)
    ...
    # ... rest of the code ...
        ...
        embed.add_field(name='Inventory', value=', '.join(user_data['inventory']) if user_data['inventory'] else 'None', inline=False)
